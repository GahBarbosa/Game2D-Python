                ...
                for col_index, col in enumerate(row):
                    if col != '-1':
                        ...
                        if style == 'grass':
                            ...
                            Tile((x,y), [self.obstacle_sprites, self.visible_sprites, self.attackable_sprites], 'grass', grass_image)
                        if style == 'object':
                            obj_image = graphics['objects'][int(col)]
                            Tile((x,y), [self.obstacle_sprites, self.visible_sprites], 'object', obj_image)
                        if style == 'entities':
                            if col == '394':
