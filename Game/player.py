...
class Player(Entity):
    ...
    def input(self):
        ...
        # weapon
        if keys[pygame.K_l] and self.weapon_switch:
        ...
        if keys[pygame.K_o] and self.magic_switch:
    ...
    def cooldowns(self):
        ...
        if not self.vulnerable: 
            if current_time - self.hit_time >= self.invencible_duration:
                self.vulnerable = True
